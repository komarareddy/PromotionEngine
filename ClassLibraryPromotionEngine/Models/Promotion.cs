...
{
    public class Promotion : OrderDetail
  {
    public IEnumerable<Item> Validate(OrderDetail order, IEnumerable<Item> validatedItems)
    {
    ...
    private void ApplyPromotionPriceAndCalculateRestQuantity(OrderDetail order, List<Item> foundItems)
    {
